...
-- if advanced electric mods ["advanced-electric-primary-steam-engine-1"]
if data.raw.recipe["advanced-electric-primary-steam-engine-1"] then
	util.conditional_modify({
	  type = "recipe",
	  name = "advanced-electric-primary-steam-engine-1",
	  normal = {
		enabled = false,
		ingredients =
		{
...
-- if advanced electric mods ["small-electric-pole-2"]
if data.raw.recipe["small-electric-pole-2"] then
	util.conditional_modify({
		type = "recipe",
